...
metadonnees : on lit donc le nom la, plutot que de se fier au nom de fichier.
    ...
    python3 frontend/tools/extraire_refs.py NETCFSetupv2.msi

Trois jeux sont produits, et la distinction compte :

* frontend/refs/          les assemblies de reference, metadonnees seules. Elles
...
* frontend/refs/runtime/  les assemblies reellement installees sur le terminal.
...
* frontend/refs/wince/    les .asmmeta "WindowsCE". Utiles pour verifier la
